...
<title>Happy Raksha-Bandha by~ vikrantup72</title>
    <meta name="google" value="notranslate">
    <meta property="og:type" content="Make your own wonderful wish for you loved once" />
    <meta property="og:title" content="Sent Raksha Bandhan Greetings to Your sister by vikrantup72" />
    <meta property="og:url" content="https://TechRipon.com/>
    <meta property="og:description" content="CLICK HERE" />
    <meta property="og:site_name" content="Create Raksha Bandhan Wishes" />
...
<center>
<!------- AdSense Code Goes Here Top Header Ads 350x50p ------------>

</center>
<center><span class="hny-txt" style="font-size: 42px;">
<img src="dd.png" width="35px"><b>
...
<img src="Snow.gif" alt="long.jpg" style="width: 100%; height:100px;"><br><br><br>
<center>
<img src="advance.png" width="60%" height="10%"style="animation: tada 4s infinite"><br><br>
<img src="happy.gif" width="80%" height="120px"style="animation: pulse 1.5s infinite"><br><br>
</center>
<center>
<!------- AdSense Code Goes Here <Responsive ads> ------------>

</center>
<img src="dd.png" height="60px" width="60px"/>
<img src="dd.png" height="60px" width="65px"/>
<img src="dd.png" height="60px" width="65px"/>
<img src="dd.png" height="60px" width="65px"/>
<img src="dd.png" height="60px" width="65px"/>
<center>
<span class="font-effect-neon" style="font-size: 15pt; font-family: 'Sofia';">
<span style="font-size: 28px;">Do You Know What is Rakhi?</span><br />
र = 🌹रक्षा करना बहन की 🌹<br/>
क्षा=🌹क्षमा करना बहन को 🌹<br/>
बं = 🌹 बंधन से मुक्त करना बहन को 🌹<br/>
ध = 🌹ध्यान रखना बहन का 🌹<br/>
न = 🌹नही भूलना बहन को 🌹<br/>
</span></p>
<img src="bhaibhn.png"  class="swing2"  height="300px" width="260px"/>
</center>
<center>
<p class="hny-txt">
 <h3> <span style="font-size: 30px;"><b>We Love Each Other</span> <span style="color: #008000;"></span></h3></p></center>
</center>

<center>
<div class="busi"><h4><p style="text-transform: uppercase;font-size: 30px;color:#ffffff;"> <script type="text/javascript" language="Javascript">                                       
 document.write( "by - " +a);
                      </script><br><br></p></h4></center>
<center>
<!------- AdSense Code Goes Here (Link Ads) ------------>
...
👉 https://happyrakshabandhan.netlify.app"><img width="25px" height="25px" src="https://i.imgur.com/fcqTtzV.png"/>  <b class="hny-txt" style="font-size: 26px;">Share on Whatsapp ~vikrantup72</b>  <img width="25px" height="25px" src="https://i.imgur.com/fcqTtzV.png"/></a></center>
